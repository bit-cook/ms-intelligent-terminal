...
pub(crate) fn session_info_to_agent_session(
        ...
        .as_str()
    {
        ...
        _ => AgentStatus::Historical,
    };
    let origin = match info
        .origin
        .as_deref()
        .unwrap_or("")
        .to_ascii_lowercase()
        .as_str()
    {
        "agentpane" | "agent_pane" => SessionOrigin::AgentPane,
    ...
    AgentSession {
        ...
        cli_source: CliSource::parse(info.cli_source.as_deref()),
...
mod tests {
    ...
    fn session_info_for_test(id: &str) -> crate::session_registry::SessionInfo {
        ...
        info.cli_source = Some("Claude".to_string());
